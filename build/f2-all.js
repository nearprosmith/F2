...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_common__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hammerjs__ = __webpack_require__(276);
...
if (!__WEBPACK_IMPORTED_MODULE_1__util_common__["isWx"] && !__WEBPACK_IMPORTED_MODULE_1__util_common__["isMy"]) {
  Hammer = __WEBPACK_IMPORTED_MODULE_2_hammerjs___default.a;
}
...
var Interaction = /*#__PURE__*/function () {
  ...
  function Interaction(cfg, chart) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["deepMix"])(this, defaultCfg, cfg);
    this.chart = chart;
  ...
  _proto._bindEvent = function _bindEvent(eventName, method) {
    ...
    if (eventName) {
      if (TOUCH_EVENTS.indexOf(eventName) !== -1) {
        Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["addEventListener"])(el, eventName, method);
      } else if (this.hammer) {
  ...
  _proto._clearTouchEvent = function _clearTouchEvent(eventName, method) {
    ...
    if (eventName && TOUCH_EVENTS.indexOf(eventName) !== -1) {
      Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["removeEventListener"])(el, eventName, method);
    }
  };
...
"use strict";
/* unused harmony export getColDef */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return getScale; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getFieldRange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return getLimitRange; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_common__ = __webpack_require__(0);
...
function getLimitRange(data, scale) {
  ...
  var field = scale.field,
      type = scale.type;
  var values = __WEBPACK_IMPORTED_MODULE_0__util_common__["Array"].values(data, field);

  if (type === 'linear') {
    result = __WEBPACK_IMPORTED_MODULE_0__util_common__["Array"].getRange(values);
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["each"])(values, function (v, i) {
      values[i] = Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["toTimeStamp"])(v);
    });
    values.sort(function (v1, v2) {
      return v1 - v2;
    });
...
"use strict";
/* unused harmony export updateLinearScale */
/* unused harmony export updateCatScale */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__helper__ = __webpack_require__(230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_common__ = __webpack_require__(0);
...
function updateLinearScale(field, min, max) {
  var chart = this.chart;
  var scale = Object(__WEBPACK_IMPORTED_MODULE_0__helper__["c" /* getScale */])(chart, field); // const colDef = Helper.getColDef(chart, field);
...
function updateCatScale(field, newValues, ticks, values, minIndex, maxIndex) {
  ...
  var scale = Object(__WEBPACK_IMPORTED_MODULE_0__helper__["c" /* getScale */])(chart, field);
  scale.change({
    values: newValues,
    ticks: ticks,
    scale: function scale(value) {
      if (this.type === 'timeCat') {
        value = Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["toTimeStamp"])(value);
      }
    ...
    getTicks: function getTicks() {
      ...
      var ticks = this.ticks;
      var rst = [];
      Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["each"])(ticks, function (tick) {
        var obj;

        if (Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["isObject"])(tick)) {
          obj = tick;
        } else {
          var value = self.scale(tick);
          value = value >= 0 && value <= 1 ? value : NaN;
          obj = {
            text: Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["isString"])(tick) ? tick : self.getText(tick),
            value: value,
...
"use strict";
/* unused harmony export _handleMove */
/* unused harmony export _doMove */
/* unused harmony export _handleLinearScale */
/* unused harmony export _handleCatScale */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_common__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helper__ = __webpack_require__(230);
...
function _doMove(deltaX, deltaY) {
  ...
  if (Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["directionEnabled"])(mode, 'x') && deltaX !== 0) {
    var xScale = chart.getXScale();
    var xField = xScale.field;

    if (!limitRange[xField]) {
      limitRange[xField] = Object(__WEBPACK_IMPORTED_MODULE_1__helper__["b" /* getLimitRange */])(data, xScale);
    }
    ...
    self.xRange = Object(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* getFieldRange */])(xScale, limitRange[xField], xScale.type);
  }

  if (Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["directionEnabled"])(mode, 'y') && deltaY !== 0) {
    var coordHeight = start.y - end.y;
    var yScales = chart.getYScales();
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["each"])(yScales, function (yScale) {
      var yField = yScale.field;

      if (!limitRange[yField]) {
        limitRange[yField] = Object(__WEBPACK_IMPORTED_MODULE_1__helper__["b" /* getLimitRange */])(data, yScale);
      }

      yScale.isLinear && self._handleLinearScale(yScale, deltaY, coordHeight, 'y');
    });
    var scale = yScales[0];
    self.yRange = Object(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* getFieldRange */])(scale, limitRange[scale.field], scale.type);
  }
...
function _handleLinearScale(scale, delta, range, flag) {
  ...
  if (limitRange[field] && !Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["isNil"])(limitRange[field].min) && newMin <= limitRange[field].min) {
    newMin = limitRange[field].min;
    newMax = max - min + newMin;
  }

  if (limitRange[field] && !Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["isNil"])(limitRange[field].max) && newMax >= limitRange[field].max) {
...
function _handleCatScale(scale, delta, range) {
  var type = scale.type,
      ...
      values = scale.values,
      ticks = scale.ticks;
  var duplicateRemovalValues = Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["uniq"])(values);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__component_guide__ = __webpack_require__(270);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__plugin_tooltip__ = __webpack_require__(248);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__plugin_guide__ = __webpack_require__(251);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__plugin_legend__ = __webpack_require__(252);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__animation_detail__ = __webpack_require__(253);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__plugin_scroll_bar__ = __webpack_require__(272);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__plugin_pie_label__ = __webpack_require__(273);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__plugin_interval_label__ = __webpack_require__(274);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__animation_animate__ = __webpack_require__(228);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__interaction__ = __webpack_require__(275);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__interaction_base__ = __webpack_require__(74);
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Interaction", function() { return __WEBPACK_IMPORTED_MODULE_15__interaction_base__["a"]; });
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "Animate", function() { return __WEBPACK_IMPORTED_MODULE_13__animation_animate__["a"]; });
/**
 * all
 */
...
__WEBPACK_IMPORTED_MODULE_0__core__["a" /* Chart */].plugins.register([__WEBPACK_IMPORTED_MODULE_6__plugin_tooltip__, __WEBPACK_IMPORTED_MODULE_8__plugin_legend__, __WEBPACK_IMPORTED_MODULE_7__plugin_guide__, __WEBPACK_IMPORTED_MODULE_9__animation_detail__, __WEBPACK_IMPORTED_MODULE_10__plugin_scroll_bar__, __WEBPACK_IMPORTED_MODULE_11__plugin_pie_label__, __WEBPACK_IMPORTED_MODULE_12__plugin_interval_label__]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  Interaction: __WEBPACK_IMPORTED_MODULE_15__interaction_base__["a" /* default */],
  Animate: __WEBPACK_IMPORTED_MODULE_13__animation_animate__["a" /* default */]
});
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__text__ = __webpack_require__(245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__line__ = __webpack_require__(243);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__arc__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__rect__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__html__ = __webpack_require__(242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__tag__ = __webpack_require__(246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__point__ = __webpack_require__(247);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__region_filter__ = __webpack_require__(271);
...
/* unused harmony reexport RegionFilter */
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__graphic_shape_rect__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_common__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base__ = __webpack_require__(18);
function _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
var RegionFilter = /*#__PURE__*/function (_GuideBase) {
  ...
  _proto.render = function render(coord) {
    ...
    var clip = new __WEBPACK_IMPORTED_MODULE_0__graphic_shape_rect__["a" /* default */]({
      attrs: {
        x: Math.min(start.x, end.x),
        y: Math.min(start.y, end.y),
        width: Math.abs(end.x - start.x),
    ...
    geoms.map(function (geom) {
      ...
      children.map(function (c) {
        if (c.get('isShape')) {
          var type = c.get('type');
          var attrs = Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["mix"])({}, c.get('attrs'), style);
  ...
  _proto.remove = function remove() {
    var element = this.element;
    Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["each"])(element, function (group) {
...
__WEBPACK_IMPORTED_MODULE_2__base__["a" /* default */].RegionFilter = RegionFilter;
/* unused harmony default export */ var _unused_webpack_default_export = (RegionFilter);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clearInner", function() { return clearInner; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "afterGeomDraw", function() { return afterGeomDraw; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interaction_helper__ = __webpack_require__(230);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_common__ = __webpack_require__(0);
...
function init(chart) {
  ...
  chart.scrollBar = function (cfg) {
    if (cfg === true) {
      cfg = DEFAULT_CFG;
    } else if (Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["isObject"])(cfg)) {
      cfg = Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["deepMix"])({}, DEFAULT_CFG, cfg);
    }
...
function afterGeomDraw(chart) {
  ...
  if (Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["directionEnabled"])(mode, 'x')) {
    ...
    if (!xLimitRange) {
      xLimitRange = Object(__WEBPACK_IMPORTED_MODULE_0__interaction_helper__["b" /* getLimitRange */])(data, xScale);
      limitRange[xScale.field] = xLimitRange;
    }

    var currentRange = Object(__WEBPACK_IMPORTED_MODULE_0__interaction_helper__["a" /* getFieldRange */])(xScale, xLimitRange, xScale.type);
  ...
  if (Object(__WEBPACK_IMPORTED_MODULE_1__util_common__["directionEnabled"])(mode, 'y')) {
    ...
    if (!yLimitRange) {
      yLimitRange = Object(__WEBPACK_IMPORTED_MODULE_0__interaction_helper__["b" /* getLimitRange */])(data, yScale);
      limitRange[yScale.field] = yLimitRange;
    }

    var _currentRange = Object(__WEBPACK_IMPORTED_MODULE_0__interaction_helper__["a" /* getFieldRange */])(yScale, yLimitRange, yScale.type);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "clearInner", function() { return clearInner; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_common__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__graphic___ = __webpack_require__(13);
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var controller = /*#__PURE__*/function () {
  function controller(cfg) {
    ...
    _defineProperty(this, "_handleEvent", function (ev) {
      ...
      var canvasEvent = Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["createEvent"])(ev, chart);
      var x = canvasEvent.x,
  ...
  _proto.renderLabels = function renderLabels() {
    ...
    shapes.forEach(function (shape) {
      ...
      var textGroup = new __WEBPACK_IMPORTED_MODULE_1__graphic___["Group"]({
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["isFunction"])(label1)) {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["isFunction"])(label2)) {
        textGroup.addShape('Text', {
          attrs: Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["mix"])({
            textBaseline: 'top'
  ...
  _proto.bindEvents = function bindEvents() {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["addEventListener"])(this.canvasDom, triggerOn, this._handleEvent);
  };

  _proto.unBindEvents = function unBindEvents() {
    var pieLabelCfg = this.pieLabelCfg;
    var triggerOn = pieLabelCfg.triggerOn || 'touchstart';
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["removeEventListener"])(this.canvasDom, triggerOn, this._handleEvent);
  };
  ...
  _proto._getSelectedShapeByData = function _getSelectedShapeByData(data) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["each"])(children, function (child) {
      if (child.get('isShape') && child.get('className') === geom.get('type')) {
        // get geometry's shape
        var shapeData = child.get('origin')._origin;

        if (Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["isObjectValueEqual"])(shapeData, data)) {
          selectedShape = child;
          return false;
        }
      }
...
function init(chart) {
  ...
  chart.pieLabel = function (cfg) {
    cfg = Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["deepMix"])({}, DEFAULT_CFG, cfg);
...
var Controller = /*#__PURE__*/function () {
  ...
  _proto.draw = function draw() {
    var chart = this.chart,
        ...
        cfg = this.cfg;
    if (!cfg) return;
    var labelCfg = Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["mix"])({}, DEFAULT_CFG, cfg);
    var geom = chart.get('geoms')[0];
    var shapes = geom.get('container').get('children');
    shapes.forEach(function (shape) {
      var origin = shape.get('origin');
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__base__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pie_select__ = __webpack_require__(277);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interval_select__ = __webpack_require__(278);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__swipe__ = __webpack_require__(279);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pan__ = __webpack_require__(280);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pinch__ = __webpack_require__(281);
/* unused harmony reexport Interaction */
/* unused harmony reexport PieSelect */
/* unused harmony reexport IntervalSelect */
/* unused harmony reexport Swipe */
/* unused harmony reexport Pan */
/* unused harmony reexport Pinch */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chart_chart__ = __webpack_require__(24);
function _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var PieSelect = /*#__PURE__*/function (_Interaction) {
  ...
  _proto.getDefaultCfg = function getDefaultCfg() {
    ...
    defaultCfg = Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["mix"])({}, defaultCfg, {
      startEvent: 'tap',
      processEvent: null,
      animate: false,
      offset: 1,
    ...
    if (__WEBPACK_IMPORTED_MODULE_0__util_common__["isWx"] || __WEBPACK_IMPORTED_MODULE_0__util_common__["isMy"]) {
      // 小程序
  ...
  function PieSelect(cfg, chart) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["isObject"])(defaultSelected)) {
  ...
  _proto._selectedShape = function _selectedShape(selectedShape) {
    ...
    if (animate) {
      ...
      halo.animate().to(Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["mix"])({
        attrs: {
          r: r + offset + appendRadius
        }
      }, animate));
...
__WEBPACK_IMPORTED_MODULE_2__chart_chart__["a" /* default */].registerInteraction('pie-select', PieSelect);
/* unused harmony default export */ var _unused_webpack_default_export = (PieSelect);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_common__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_helper__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__chart_chart__ = __webpack_require__(24);
function _inheritsLoose(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
var IntervalSelect = /*#__PURE__*/function (_Interaction) {
  ...
  _proto._selectShapes = function _selectShapes(selectedShape, unSelectedShapes) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["each"])(unSelectedShapes, function (child) {
    ...
    if (this.selectAxis) {
      ...
      var axisShape;
      Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["each"])(frontPlot.get('children').concat(backPlot.get('children')), function (s) {
  ...
  _proto.start = function start(ev) {
    ...
    if (mode === 'shape') {
      ...
      if (!Object(__WEBPACK_IMPORTED_MODULE_1__util_helper__["isPointInPlot"])({
        x: x,
        y: y
      }, plot)) {
        this.reset();
...
__WEBPACK_IMPORTED_MODULE_3__chart_chart__["a" /* default */].registerInteraction('interval-select', IntervalSelect);
/* unused harmony default export */ var _unused_webpack_default_export = (IntervalSelect);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__base__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chart_chart__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixin_move__ = __webpack_require__(262);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mixin_update_scale__ = __webpack_require__(260);
function _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var Swipe = /*#__PURE__*/function (_Interaction) {
  ...
  function Swipe(cfg, chart) {
    ...
    self.mode = 'x';
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["mix"])(self, __WEBPACK_IMPORTED_MODULE_4__mixin_update_scale__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__mixin_move__["a" /* default */]);
    return _this;
  }
...
__WEBPACK_IMPORTED_MODULE_2__chart_chart__["a" /* default */].registerInteraction('swipe', Swipe);
/* unused harmony default export */ var _unused_webpack_default_export = (Swipe);
...
var Pan = /*#__PURE__*/function (_Interaction) {
  ...
  function Pan(cfg, chart) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["mix"])(_assertThisInitialized(_this), __WEBPACK_IMPORTED_MODULE_4__mixin_update_scale__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__mixin_move__["a" /* default */]);
    return _this;
  }
...
__WEBPACK_IMPORTED_MODULE_2__chart_chart__["a" /* default */].registerInteraction('pan', Pan);
/* unused harmony default export */ var _unused_webpack_default_export = (Pan);
...
var Pinch = /*#__PURE__*/function (_Interaction) {
  ...
  _proto.getDefaultCfg = function getDefaultCfg() {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["mix"])({}, defaultCfg, {
  ...
  function Pinch(cfg, chart) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["mix"])(self, __WEBPACK_IMPORTED_MODULE_4__mixin_update_scale__["a" /* default */]);
    return _this;
  }
  ...
  _proto._doZoom = function _doZoom(diff, center, whichAxes) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["directionEnabled"])(mode, 'x') && Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["directionEnabled"])(_whichAxes, 'x')) {
      // x
      var xScale = chart.getXScale();
      var xField = xScale.field;
      ...
      this.xRange = Object(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* getFieldRange */])(xScale, limitRange[xField], xScale.type);
    }

    if (Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["directionEnabled"])(mode, 'y') && Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["directionEnabled"])(_whichAxes, 'y')) {
      // y
      var yScales = chart.getYScales();
      Object(__WEBPACK_IMPORTED_MODULE_0__util_common__["each"])(yScales, function (yScale) {
        var yField = yScale.field;
      ...
      var scale = yScales[0];
      this.yRange = Object(__WEBPACK_IMPORTED_MODULE_1__helper__["a" /* getFieldRange */])(scale, limitRange[scale.field], scale.type);
    }
...
__WEBPACK_IMPORTED_MODULE_3__chart_chart__["a" /* default */].registerInteraction('pinch', Pinch);
/* unused harmony default export */ var _unused_webpack_default_export = (Pinch);
